...
- Chat SDK for iOS is 3.0.205 or later
...
> __Note__: Sendbird UIKit for iOS is `Sendbird Chat SDK-dependent`. If you install the UIKit, `CocoaPods` will automatically install the Chat SDK for iOS as well. The minimum requirement of the Chat SDK for iOS is 3.0.205 or later. 

#### - Carthage

1.Add `SendBirdUIKit`and `SendBirdSDK`into your `Cartfile` as below:

> __Note__: Sendbird UIKit for iOS is `Sendbird Chat SDK-dependent`. The minimum requirement of the Chat SDK for iOS is 3.0.205 or later. 
